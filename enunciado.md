...
La aplicación a desarrollar tiene los mismos requisitos que la
aplicación desarrollada en la práctica 1, con la excepión de que se
trata de una aplicación para dispositivos móviles.
...
### :wrench: Esta tarea tiene las siguientes partes:
  ...
  1. Recupera los casos de uso relevantes que identificaste en la
     práctica anterior.
  
  2. Realiza un diseño de la interfaz de usuaria apropiado para un
     dispositivo móvil.
  
     - El diseño debe adaptarse a distintos tamaños de pantalla, y a
       la orientación de la misma.
	   
     - Es imprescindible que el diseño se diferencie claramente para
       los teléfonos y las tablets.

     - Incluye en el diseño los elementos necesarios para la gestión
       de errores, retroalimentación a la usuaria, ...
	 
     - Añade el diseño al repositorio en un fichero `diseño-iu.pdf` en
       formato _PDF_.
	 
  3. Selecciona un patrón arquitectónico para gestionar el estado de
     la aplicación de manera que el componente de la _vista_ sea
     independiente del _estado/modelo_.
	 
	 - El patrón debe ser adecuado para la aplicación y para su
       implementación con _flutter_.
	 
  4. Realizar un diseño software siguiendo el patrón seleccionado.
	  ...
	  - Añade el diseño software al repositorio en un fichero
        `diseño_sw.md`. El formato del fichero es la versión de
        _markdown_ [Github Flavored
...
### :wrench: Esta tarea tiene las siguientes partes:
  ...
  1. Implementa la aplicación siguiendo los diseños realizados.
...
> de una aplicación para dispositivos móviles. Cerciórate de que la
> aplicación efectivamente funciona como se espera en android y/o
> ios. La defensa de la práctica también se realizará ejecutando la
...
### :wrench: Esta tarea tiene las siguientes partes:
  ...
  1. Usando la libreráis de testing de flutter y siguiendo la
     documentación de diseño, implementa pruebas de tipo _end to end_
     para los distintos caso de uso de la aplicación.
	 
  2. Implementa tests para las situaciones en que ocurren errores de
